...
public class Mystyr extends Bot {
    ...
    public Mystyr(){
        super("Mystyr","assets/Profile/Mystyr.webp","She is fear to death, so she is always wanting to play safe by increase her self HP before everything (Even her signature is about darkness anyway)","Mstxz");
    }
